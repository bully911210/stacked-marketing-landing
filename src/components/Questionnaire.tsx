...
export default function Questionnaire() {
    ...
    return (
      <section id="questionnaire" className="py-20 sm:py-28 bg-dark-lighter relative">
        <div className="max-w-lg mx-auto px-4 text-center animate-fade-in-up">
          {/* Checkmark */}
          <div className="w-24 h-24 mx-auto mb-8 rounded-full bg-whatsapp/20 flex items-center justify-center pulse-glow">
          ...
          <a
            ...
            className="btn-primary inline-flex items-center gap-3 bg-whatsapp hover:bg-whatsapp-dark text-white font-bold text-lg px-8 py-4 rounded-xl shadow-lg shadow-whatsapp/20"
          >
  ...
  const inputClass = (field: string) =>
    ...
    } rounded-lg px-4 py-3 text-white placeholder-gray-500 focus:outline-none input-glow`;

  const labelClass = "block text-sm font-semibold text-gray-300 mb-2";

  return (
    <section id="questionnaire" className="py-20 sm:py-28 bg-dark-lighter relative overflow-hidden">
      {/* Ambient background */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[700px] bg-amber-brand/5 rounded-full blur-3xl pointer-events-none" />

      <div className="max-w-2xl mx-auto px-4 sm:px-6 relative z-10">
        {/* Header */}
        <div className="text-center mb-8">
          <h2 className="text-3xl sm:text-4xl font-black mb-3">
            Let&apos;s Build <span className="gradient-text-animate">Your Website</span>
          </h2>
        ...
        <div className="mb-8">
          ...
          <div className="h-2.5 bg-dark rounded-full overflow-hidden border border-white/5">
            <div
        ...
        <div className="gradient-border-always relative glass-card-strong rounded-2xl p-6 sm:p-8">
          ...
          {step === 1 && (
            <div className={direction === "left" ? "slide-left" : "slide-right"}>
              ...
              <button onClick={nextStep} className="btn-primary w-full mt-8 bg-amber-brand hover:bg-amber-brand-dark text-dark font-extrabold py-4 rounded-xl text-lg shadow-lg shadow-amber-brand/20">
          ...
          {step === 2 && (
            <div className={direction === "left" ? "slide-left" : "slide-right"}>
              ...
              <div className="flex gap-3 mt-8">
                <button onClick={prevStep} className="btn-back px-6 py-4 rounded-xl border border-white/10 text-gray-400 font-semibold">
                  Back
                </button>
                <button onClick={nextStep} className="btn-primary flex-1 bg-amber-brand hover:bg-amber-brand-dark text-dark font-extrabold py-4 rounded-xl text-lg shadow-lg shadow-amber-brand/20">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {CTA_ACTIONS.map((action) => (
                      <button
                        ...
                        className={`p-3 rounded-lg border text-sm font-medium transition-all duration-300 text-left ${
                          formData.ctaActions.includes(action)
                            ? "border-amber-brand bg-amber-brand/10 text-amber-brand shadow-md shadow-amber-brand/10"
                            : "border-white/10 text-gray-400 hover:border-white/20 hover:bg-white/5"
                        }`}
                      >
                        <span className="flex items-center gap-2">
                          <span className={`w-4 h-4 rounded border flex-shrink-0 flex items-center justify-center transition-all duration-300 ${
                            formData.ctaActions.includes(action)
                  ...
                  <div className="flex gap-3">
                    {["Yes", "No", "I need one"].map((opt) => (
                      <button
                        ...
                        className={`flex-1 p-3 rounded-lg border text-sm font-medium transition-all duration-300 ${
                  ...
                  {formData.hasLogo === "Yes" && (
                    <div className="mt-3">
                      ...
                      <button
                        ...
                        className="upload-area w-full p-5 rounded-xl text-gray-400 hover:text-amber-brand transition-colors text-sm bg-dark/50"
                      >
                        {logoFile ? (
                          ...
                          <span className="flex flex-col items-center gap-2">
                            <svg className="w-8 h-8 text-amber-brand/50" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
            ...
            <div className={direction === "left" ? "slide-left" : "slide-right"}>
                  ...
                  <div className="flex gap-3">
                    {["Yes, I'll send them", "No, use stock photos", "Some of both"].map((opt) => (
                      <button
                        ...
                        className={`flex-1 p-3 rounded-lg border text-xs sm:text-sm font-medium transition-all duration-300 ${
              ...
              <div className="flex gap-3 mt-8">
                ...
                <button
                  ...
                  disabled={submitting}
                  className="btn-primary flex-1 bg-amber-brand hover:bg-amber-brand-dark text-dark font-extrabold py-4 rounded-xl text-lg disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-amber-brand/20"
                >
                  {submitting ? (

      ...
      <div className="container-main">
        <div ref={ref} className={`fade-up ${isVisible ? "visible" : ""}`}>
          ...
          <p style={{
            ...
            Fill in the form — we WhatsApp you within 24 hours with a straight answer. Free. No obligation.
          </p>
        </div>
        ...
        >
          ...
          <button type="submit" className="btn-primary" disabled={submitting}
            style={{ width: "100%", marginTop: 24, padding: "18px 32px", fontSize: "1rem", fontWeight: 600, opacity: submitting ? 0.7 : 1 }}>
        ...
        <div style={{ textAlign: "center", marginTop: 24 }}>
          ...
          >
            ...
            Or WhatsApp us directly: +27 62 177 9799
          </a>
        </div>
      </div>

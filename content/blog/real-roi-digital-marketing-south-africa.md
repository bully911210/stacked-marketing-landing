...
### Cost Per Lead (CPL)
**What it is:** How much you spend to generate one enquiry.
**How to calculate:** Total ad spend ÷ number of leads.
**SA benchmarks:** R25–R120 for most industries on Meta.
...
**How to calculate (simplified):** Average transaction value × average number of transactions × average customer lifespan.
...
1. **The marketing is genuinely bad** — wrong platform, wrong targeting, wrong creative
2. **The website doesn't convert** — marketing is driving traffic but the site leaks leads
3. **The follow-up is broken** — leads exist but nobody's closing them
4. **They can't measure** — marketing is working but they have no visibility into the numbers

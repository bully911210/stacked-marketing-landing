...
### How to Set It Up
1. Export your customer list with two columns: identifier (email or phone) and value (revenue amount)
2. Upload as a Custom Audience in Ads Manager, selecting the "value" column
3. Create a Lookalike from this audience
...
1. Export your customer list (even if it's just 100 people)
2. Upload it as a Custom Audience in Meta Ads Manager
3. Create a 1% Lookalike audience for South Africa
4. Run a lead gen campaign targeting only that Lookalike
5. Compare performance against your interest-based campaigns

...
1. **R5,000:** Website + first month of ads (testing)
2. **R10,000/month:** Ads + basic automation (optimising)
3. **R20,000/month:** Ads + website improvements + full automation (scaling)
4. **R50,000/month:** Multiple campaigns + retargeting + content + advanced automation (dominating)

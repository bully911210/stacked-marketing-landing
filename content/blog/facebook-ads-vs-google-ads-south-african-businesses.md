...
1. **Facebook runs awareness and lead gen** — Building audiences, generating enquiries, creating demand
2. **Google catches the search demand** — When Facebook creates awareness, some people go to Google to research before buying. Your Google Ads catch them there.
3. **Facebook retargets Google visitors** — Someone clicks your Google ad, visits your site, doesn't convert. Facebook retargets them with social proof and testimonials.
...
1. **Lower cost per lead** in most SA industries
2. **Audience building** gives you compounding returns
3. **More creative control** lets you differentiate from competitors
4. **Better for education-based selling** which is how most SA businesses need to sell
5. **Works at lower budgets** — you can get meaningful data from R5,000/month

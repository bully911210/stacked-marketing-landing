...
### What Performs Well
1. **Authentic content** beats polished content. A well-lit phone video of someone talking to camera outperforms a stock photo with overlaid text in nearly every test we've run.

2. **Faces perform better than graphics.** Ads showing real people (especially looking at camera) get 20–30% higher engagement than branded graphics.

3. **Movement stops thumbs.** Even a simple animated text reveal or a slow pan across a product catches attention more effectively than a static image.

4. **Text on image works — but keep it minimal.** Instagram users expect clean visuals. A bold headline overlaid on an image works. A paragraph of text crammed onto a square image doesn't.

5. **User-generated style outperforms branded style.** Ads that look like organic Instagram posts (not like traditional ads) get higher engagement because they feel native to the platform.
...
Pros: Lowest friction, highest volume
Cons: Lead quality can be lower (too easy to submit)
...
Pros: Better qualification, more information captured
Cons: Higher drop-off (every extra step loses people)
...
Pros: Personal, high conversion rate, feels natural
Cons: Requires fast response (automation helps)
...
1. Make sure your Instagram account is connected to your Business Manager
2. Enable Advantage+ Placements (or add Instagram placements manually)
3. Create at least one vertical (9:16) variation of your best ad
4. Monitor placement breakdown in Ads Manager to see where Instagram delivers
